...
/** constructor **/
Cube::Cube(int cubesNo = 0, int ltNo = 0, int lc = 0, int NROUND1 = 384, int NROUND2 = 1024)
{
...
void Cube::generateCube()
{
    ...
    // generatedCube.clear();
    // generatedCube.push_back(52);
    // generatedCube.push_back(54);
    // generatedCube.push_back(57);
    // generatedCube.push_back(58);
