...
class Cube
{
    public:
        ...
        void printCubeSpaceToFile(std::ofstream&);
...
Cube::Cube()
{
    ...
    getline(fileCoefficients, tempStr);
    fileCubeSpace.open("successfulCubeSpace.txt");
...
bool Cube::readCubesFromFile()
{
    ...
    std::getline(fileCubeSpace, cubeSpace);
    ...
    while(readCubesFromFile())
    {
        if(readCube.size())
        {
            ...
            if(correctCube)
            {
                ...
                printCubeSpaceToFile(fileFilteredCubeSpace);
            ...
            else
            {
                ...
                printCubeSpaceToFile(fileFalseCubeSpace);
...
void Cube::printCubeSpaceToFile(std::ofstream& theFile)
{
    theFile << std::endl << cubeSpace;
}
#endif // CUBE_H
